...
public class Storage {
  ...
  static String version = "1.3"; //TODO Change version number according to pom.xml
  ...
  static List<Song> singles = Arrays.asList(
      ...
      new Song(17, "Jamsession 2 (feat. Dernerl)", "Jammin' again in even worse quality.", "jamsession2.png", "24 January 2015", "jamsession2.mp3", 0.00, true)
  );
